...
function handleAnswerRequest(intent, session, callback) {
    ...
    if (!gameInProgress) {
        ...
        if (currentQuestionIndex == GAME_LENGTH - 1) {
            ...
            if(currentScore > 10)
            {
                anal = "Based upon your responses to this screening measure, you are most likely involved in an abusive relationship." + 
                "You should seek immediate assistance within your local community from a mental health or social services professional to help you deal with this situation. ";
            }
            else if(currentScore > 5)
            {
                anal = "Based upon your responses to this screening measure, you may be involved in a relationship that could be considered abusive, either emotionally or physically.";
            }
            else
            {
                anal = "You have answered this domestic violence screening in such a way as to suggest that you are not likely currently in an abusive (emotionally or physically) relationship. ";
            }
            //speechOutput = userGaveUp ? "" : "That answer is ";
            speechOutput += "You got a score of" + currentScore.toString() + ". " + anal;
            ...
            speechOutput += userGaveUp ? "" : "That answer is ";
            speechOutput += "Your score is " + currentScore.toString() + ". " + repromptText;
